...
import DemoCTA from '@/components/3d/DemoCTA';

// Dynamic import for 3D scene (client-side only)
const DemoScene = dynamic(() => import('@/components/3d/DemoScene'), {
  ssr: false,
  loading: () => (
    <div className="w-full h-full flex items-center justify-center">
      <div className="text-center">
        <div className="w-20 h-20 mx-auto mb-4 border-4 border-orange-500/30 border-t-orange-500 rounded-full animate-spin" />
        <p className="text-gray-400 text-sm">3D Sahne Yükleniyor...</p>
      </div>
    </div>
  ),
});
    ...
    <main className="relative min-h-screen bg-[#0D0D0F] overflow-hidden">
      ...
      >
        <div className="container mx-auto flex items-center justify-between">
          ...
          <Link
            href="/"
            className="flex items-center gap-2 px-4 py-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl text-gray-300 hover:text-white hover:bg-white/10 transition-all duration-300 group"
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-xs text-gray-500">3D Demo Deneyimi</p>
            </div>
          </div>
          ...
          <a
            ...
            className="flex items-center gap-2 px-4 py-2 bg-green-500/20 border border-green-500/30 rounded-xl text-green-400 hover:bg-green-500/30 transition-all duration-300"
          >
      ...
      {/* Main Content */}
      <div className="relative z-10 h-screen pt-20 pb-32">
        {/* Title */}
        <motion.div
        ...
        >
          ...
          <p className="text-gray-400 max-w-xl mx-auto text-sm md:text-base">
            Telefonunuzda QR menünün nasıl görüneceğini 3 boyutlu olarak deneyimleyin
          </p>
        </motion.div>
